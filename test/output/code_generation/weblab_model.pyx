...
#
# Generated by fc on 2021-03-18 11:33:44
#
#
#
...
cdef int _evaluate_rhs(Sundials.realtype var_time,
    ...
    cdef double var_alpha_n = ((-1.0000000000287556e-08 / (-1.0 + math.exp(-1.0000000000287557e-07)) - 499999.9999856222 * (64.999999 + var_V) * (1.0000000000287556e-08 / (-1.0 + math.exp(1.0000000000287557e-07)) + 1.0000000000287556e-08 / (-1.0 + math.exp(-1.0000000000287557e-07)))) if (abs(65.0 + var_V) < 1.0000000000287557e-06) else (-0.01 * (65.0 + var_V) / (-1.0 + math.exp(-6.5 - 0.1 * var_V))))
    ...
    cdef double var_alpha_m = ((-1.0000000000287557e-07 / (-1.0 + math.exp(-1.0000000000287557e-07)) - 499999.9999856222 * (49.999999 + var_V) * (1.0000000000287557e-07 / (-1.0 + math.exp(1.0000000000287557e-07)) + 1.0000000000287557e-07 / (-1.0 + math.exp(-1.0000000000287557e-07)))) if (abs(50.0 + var_V) < 1.0000000000287557e-06) else (-0.1 * (50.0 + var_V) / (-1.0 + math.exp(-5.0 - 0.1 * var_V))))
