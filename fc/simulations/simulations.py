...
class AbstractSimulation(locatable.Locatable):
    ...
    def add_iteration_outputs(self, outputsList):
        ...
        if self_results is not None:
            ...
            if not self_results:
                ...
                for name, output in zip(self.model.output_names, outputsList):
    ...
    def internal_run(self, verbose=True):
        for t in self.range_:
            ...
            if self.outputFolder:
                self.nestedSim.set_output_folder(self.outputFolder.create_subfolder(
